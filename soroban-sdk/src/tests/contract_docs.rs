mod fn_ {
    ...
    use hcnet_xdr::{Limits, ReadXdr, ScSpecEntry, ScSpecFunctionV0};
...
mod struct_ {
    ...
    use hcnet_xdr::curr as hcnet_xdr;
    use hcnet_xdr::{Limits, ReadXdr, ScSpecEntry, ScSpecUdtStructFieldV0, ScSpecUdtStructV0};
        ...
        let expect = ScSpecEntry::UdtStructV0(ScSpecUdtStructV0 {
            ...
            fields: [
                ScSpecUdtStructFieldV0 {
                    ...
                    type_: hcnet_xdr::ScSpecTypeDef::U64,
                },
                ScSpecUdtStructFieldV0 {
...
mod enum_int {
    ...
    use soroban_sdk::contracttype;
    use hcnet_xdr::curr as hcnet_xdr;
    use hcnet_xdr::{Limits, ReadXdr, ScSpecEntry, ScSpecUdtEnumCaseV0, ScSpecUdtEnumV0};
